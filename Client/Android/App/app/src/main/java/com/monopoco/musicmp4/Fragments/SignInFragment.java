...
public class SignInFragment extends Fragment {
    ...
    private void handleLogin() {
        ...
        APIService.getService(null).Login(loginBody).enqueue(new Callback<ResponseCommon<LoginResponse>>() {
            @Override
            public void onResponse(Call<ResponseCommon<LoginResponse>> call, Response<ResponseCommon<LoginResponse>> response) {
...
//                    Ed.putString("userId", response.body().getUserId());
                    ...
                    Ed.putString("accessToken", response.body().getData().getAccessToken());
                    Ed.commit();
            ...
            @Override
            public void onFailure(Call<ResponseCommon<LoginResponse>> call, Throwable t) {
                loading.setVisibility(View.GONE);
