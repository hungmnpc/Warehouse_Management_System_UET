package com.monopoco.purchaseorder.filter;
...
public class CustomerAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (requestWrapper.getServletPath().equals("/login")) {
            ...
            if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
                try {
                    ...
                    responseWrapper.setHeader("error", ex.getMessage());
                    responseWrapper.setStatus(FORBIDDEN.value());
        ...
        if (requestWrapper.getServletPath().startsWith("/purchase_orders") && !StringUtils.isEmpty(responseBody)) {
            ...
            if (res.getHistory() != null) {
                purchaseOrderProducer.sendMessage(res.getHistory());
            }
        }
