package com.monopoco.purchaseorder.util;

import com.auth0.jwt.JWT;
import com.auth0.jwt.algorithms.Algorithm;
import com.monopoco.purchaseorder.response.UserPrincipal;
...
public class CommonUtil {
    ...
    public static String generatePOCode() {
        ...
        String timestamp = sdf.format(new Date()); // Dấu thời gian hiện tại

        // Tiền tố cho mã PO
        String prefix = "PO";

        // Tạo mã PO với tiền tố và dấu thời gian
        String poCode = prefix + "-" + timestamp;
