...
public class SocketProducer {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(SocketProducer.class);

    private NewTopic topic;

    private KafkaTemplate<String, HistoryEvent> kafkaTemplate;

    public SocketProducer(NewTopic topic, KafkaTemplate<String, HistoryEvent> kafkaTemplate) {
        this.topic = topic;
