...
public class CommonResponse<T> {
    ...
    public CommonResponse isExisted(String message) {
        this.result = new Result().errorCode("401").message(message).isOk(false);
        return this;
    }
    public CommonResponse isExisted() {
        this.result = new Result().errorCode("401").message("Resource existed").isOk(false);
        return this;
    }
